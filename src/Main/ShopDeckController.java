...
public class ShopDeckController extends Main implements Initializable {
	...
	public void onBackPressed() {
		Main.currentStage.setScene(MenuController.shopScene);
	}
	
	@Override
	public void initialize(URL arg0, ResourceBundle arg1) {
		ammount = hero.getDeck().size();
	...
	private void Card0_refresh() {
		Cards tmpcard = hero.getDeck().get(page * 6);
	...
	private void Card1_refresh() {
		Cards tmpcard = hero.getDeck().get(page * 6 + 1);
	...
	private void Card2_refresh() {
		Cards tmpcard = hero.getDeck().get(page * 6 + 2);
	...
	private void Card3_refresh() {
		Cards tmpcard = hero.getDeck().get(page * 6 + 3);
	...
	private void Card4_refresh() {
		Cards tmpcard = hero.getDeck().get(page * 6 + 4);
	...
	private void Card5_refresh() {
		Cards tmpcard = hero.getDeck().get(page * 6 + 5);
